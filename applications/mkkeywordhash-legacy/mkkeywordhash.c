...
/* Number of keywords */
int nKeyword = (sizeof(aKeywordTable)/sizeof(aKeywordTable[0]));
...
*/
int keywordCompare1(const void *a, const void *b){
...
int keywordCompare2(const void *a, const void *b){
  const Keyword *pA = (Keyword*)a;
  const Keyword *pB = (Keyword*)b;
...
int keywordCompare3(const void *a, const void *b){
  const Keyword *pA = (Keyword*)a;
  const Keyword *pB = (Keyword*)b;
...
int main(int argc, char **argv){
  ...
  ** number of collisions */
  ...
  printf("const unsigned char aKWHash[%d] = {\n", bestSize);
  ...
  printf("const unsigned char aKWNext[%d] = {0,\n", nKeyword+1);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("const unsigned char aKWLen[%d] = {0,\n", nKeyword+1);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("const unsigned short int aKWOffset[%d] = {0,\n", nKeyword+1);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("const unsigned char aKWCode[%d] = {0,\n", nKeyword+1);
  for(i=j=0; i<nKeyword; i++){
  ...
  printf("i64 keywordCode(const char *z, i64 n, int *pType){\n");
  printf("  i64 i, j;\n");
