...
typedef struct fts5_extension_function fts5_extension_function;
...
typedef struct sqlite3_callback sqlite3_callback;
typedef struct Sqlite3Config Sqlite3Config;
typedef struct sqlite3_context sqlite3_context;
typedef struct sqlite3_destructor_type sqlite3_destructor_type;
typedef struct sqlite3_file sqlite3_file;
typedef struct sqlite3_filename sqlite3_filename;
typedef struct sqlite3 sqlite3;
typedef struct sqlite3_hard_heap sqlite3_hard_heap;
typedef struct sqlite3_index_info sqlite3_index_info;
typedef struct sqlite3_io_methods sqlite3_io_methods;
typedef struct sqlite3_libversion sqlite3_libversion;
typedef struct sqlite3_libversion_number sqlite3_libversion_number;
...
typedef struct sqlite3_sourceid sqlite3_sourceid;
typedef struct sqlite3StatType sqlite3StatType;
typedef struct sqlite3_stmt sqlite3_stmt;
typedef struct sqlite3_str sqlite3_str;
typedef struct sqlite3_syscall_ptr sqlite3_syscall_ptr;
typedef struct sqlite3_value sqlite3_value;
typedef struct sqlite3_version sqlite3_version;
typedef struct sqlite3_vfs sqlite3_vfs;
typedef struct sqlite3_vtab_cursor sqlite3_vtab_cursor;
typedef struct sqlite3_vtab sqlite3_vtab;
typedef struct sqlite3_xauth sqlite3_xauth;
typedef struct sqlite_int64 sqlite_int64;
typedef struct SQLiteThread SQLiteThread;
typedef struct sqlite_uint64 sqlite_uint64;
