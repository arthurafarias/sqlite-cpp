...
#ifndef SQLITE3_H
#define SQLITE3_H
#include "sqlite/stdarg.h"     /* Needed for the definition of va_list */
...
** SQLITE_TRANSIENT. The T parameter should be a string,
...
** that the data and the destructor is never invoked.  If the X
